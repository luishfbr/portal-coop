...
function useDirection() {
  const context = React2.useContext(DirectionContext);
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React3.useState(null);
  ...
  const arrowRef = React3.useRef(null);
  ...
  const autoUpdateOptions = React3.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React3.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React3.useMemo(() => ({
    position: "absolute",
...
//# sourceMappingURL=chunk-FGLRX5WK.js.map
