...
var InternalBackdrop = React4.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
function useEnhancedClickHandler(handler) {
  const lastClickInteractionTypeRef = React6.useRef("");
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React7.useState(null);
...
//# sourceMappingURL=chunk-UW7AXSTZ.js.map
