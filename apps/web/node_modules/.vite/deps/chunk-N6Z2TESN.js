...
var useFloatingParentNodeId = () => React4.useContext(FloatingNodeContext)?.id || null;
...
function fastComponentRef(fn) {
  return React9.forwardRef(fastComponent(fn));
}
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React10.useRef(null);
  const registeredElementRef = React10.useRef(null);
  return React10.useCallback((element) => {
    if (id === void 0) {
      return;
    }
...
//# sourceMappingURL=chunk-N6Z2TESN.js.map
