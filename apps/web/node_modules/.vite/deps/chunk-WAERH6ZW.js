...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React3.useState(false);
  useIsoLayoutEffect(() => {
...
var ToolbarRootContext = React4.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React4.useContext(ToolbarRootContext);
...
//# sourceMappingURL=chunk-WAERH6ZW.js.map
