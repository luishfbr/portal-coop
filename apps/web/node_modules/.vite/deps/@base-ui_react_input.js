...
var FieldItemContext = React11.createContext({
  disabled: false
});
...
var CheckboxGroupContext = React12.createContext(void 0);
if (true) CheckboxGroupContext.displayName = "CheckboxGroupContext";
function useCheckboxGroupContext(optional = true) {
  const context = React12.useContext(CheckboxGroupContext);
...
var FieldItem = React13.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const fieldItemContext = React13.useMemo(() => ({
    disabled
  }), [disabled]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
