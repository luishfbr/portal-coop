...
import {
  error
} from "./chunk-QMOO66NM.js";
import {
  SafeReact
} from "./chunk-L4NBHMGE.js";
import "./chunk-AIAF7FXM.js";
...
function useFieldValidation(params) {
  ...
  const getValidationProps = React4.useCallback((externalProps = {}) => mergeProps(getDescriptionProps, state.valid === false ? {
    "aria-invalid": true
  } : EMPTY_OBJECT, externalProps), [getDescriptionProps, state.valid]);
  const getInputValidationProps = React4.useCallback((externalProps = {}) => mergeProps({
    onChange(event) {
...
var FieldRootInner = React6.forwardRef(function FieldRootInner2(componentProps, forwardedRef) {
  ...
  const markedDirtyRef = React6.useRef(false);
  ...
  const handleImperativeValidate = React6.useCallback(() => {
    markedDirtyRef.current = true;
...
var FieldLabel = React7.forwardRef(function FieldLabel2(componentProps, forwardedRef) {
  ...
  const labelRef = React7.useRef(null);
...
var FieldError = React8.forwardRef(function FieldError2(componentProps, forwardedRef) {
  ...
  const errorRef = React8.useRef(null);
  const [lastRenderedMessage, setLastRenderedMessage] = React8.useState(null);
  const [lastRenderedMessageKey, setLastRenderedMessageKey] = React8.useState(null);
...
var FieldControl = React10.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React11.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React11.useMemo(() => {
    return {
...
var FieldItemContext = React12.createContext({
  disabled: false
});
