...
var ToolbarRootContext = React3.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React3.useContext(ToolbarRootContext);
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React5.useState(false);
  useIsoLayoutEffect(() => {
...
//# sourceMappingURL=chunk-GQEUMUR3.js.map
