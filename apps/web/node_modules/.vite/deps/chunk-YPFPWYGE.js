...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React6.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React6.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React6.useState(null);
  const currentContainerRef = React6.useRef(null);
  const previousContainerRef = React6.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React6.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React6.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const lastHandledTriggerRef = React6.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime2.jsxs)(React6.Fragment, {
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React6.useState(0);
  const previousActiveTriggerIdRef = React6.useRef(activeTriggerId);
  const previousPayloadRef = React6.useRef(payload);
  const pendingPayloadUpdateRef = React6.useRef(false);
  useIsoLayoutEffect(() => {
...
//# sourceMappingURL=chunk-YPFPWYGE.js.map
