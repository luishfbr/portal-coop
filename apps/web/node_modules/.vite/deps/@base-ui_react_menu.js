import {
  useControlled
} from "./chunk-E2HQODGL.js";
import {
  Separator
} from "./chunk-2DGMF4Y2.js";
import {
  adaptiveOrigin,
  ...
  usePopupViewport,
  usePositioner
} from "./chunk-YPFPWYGE.js";
import {
  COMPOSITE_KEYS,
  InternalBackdrop,
  useOpenInteractionType,
  useScrollLock
} from "./chunk-45QO5A7P.js";
import {
  ...
  useTypeahead
} from "./chunk-7ZPS2ALU.js";
import "./chunk-QWEGC7DX.js";
import {
  contains,
  ...
  useBaseUiId,
  useId
} from "./chunk-IZTQEPNJ.js";
import {
  useButton,
  useCompositeRootContext
} from "./chunk-A2526K5I.js";
import "./chunk-QMOO66NM.js";
import {
  SafeReact,
  getParentNode,
  getWindow,
...
import {
  ...
  useRenderElement,
  warn
} from "./chunk-RZNSQOCZ.js";
import {
  mergeProps
} from "./chunk-UAYWVPZW.js";
import {
  require_react
...
function CompositeList(props) {
  ...
  const [mapTick, setMapTick] = React22.useState(0);
  const lastTickRef = React22.useRef(mapTick);
  ...
  const sortedMap = React22.useMemo(() => {
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React23.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuPositioner = React24.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React24.useRef(null);
...
var MenuRadioGroupContext = React25.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React25.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React26.memo(React26.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
...
var MenuRadioItemContext = React27.createContext(void 0);
if (true) MenuRadioItemContext.displayName = "MenuRadioItemContext";
function useMenuRadioItemContext() {
  const context = React27.useContext(MenuRadioItemContext);
  if (context === void 0) {
...
var MenuRadioItem = React28.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuRadioItemIndicator = React29.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var MenubarContext = React30.createContext(null);
if (true) MenubarContext.displayName = "MenubarContext";
function useMenubarContext(optional) {
  const context = React30.useContext(MenubarContext);
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React31.createRef(),
      popupRef: React31.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React31.createRef(),
      beforeContentFocusGuardRef: React31.createRef(),
...
var MenuSubmenuRootContext = React32.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React32.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React33.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React33.useRef(null);
  ...
  const allowOutsidePressDismissalRef = React33.useRef(parent.type !== "context-menu");
  ...
  const allowTouchToCloseRef = React33.useRef(true);
  ...
  const createMenuEventDetails = React33.useCallback((reason) => {
  ...
  React33.useImperativeHandle(ctx?.positionerRef, () => positionerElement, [positionerElement]);
  React33.useImperativeHandle(ctx?.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  ...
  const setActiveIndex = React33.useCallback((index) => {
  ...
  const onTypingChange = React33.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React33.useMemo(() => {
  ...
  const inactiveTriggerProps = React33.useMemo(() => {
  ...
  const popupProps = React33.useMemo(() => getFloatingProps({
    onMouseMove() {
      store.set("allowMouseEnter", true);
      if (parent.type === "menu") {
        store.set("hoverEnabled", false);
  ...
  const itemProps = React33.useMemo(() => getItemProps(), [getItemProps]);
  store.useSyncedValues({
    floatingRootContext,
    activeTriggerProps,
...
function useCompositeItem(params = {}) {
  ...
  const compositeProps = React35.useMemo(() => ({
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React36.useRef(null);
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React37.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const floatingTreeRoot = React38.useMemo(() => {
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime11.jsxs)(React38.Fragment, {
      children: [(0, import_jsx_runtime11.jsx)(FocusGuard, {
        ref: preFocusGuardRef,
        onFocus: handlePreFocusGuardFocus
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime11.jsx)(React38.Fragment, {
        children: element
  ...
  return (0, import_jsx_runtime11.jsx)(React38.Fragment, {
    children: element
  }, thisTriggerId);
});
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React38.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuViewport = React39.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
// ../../node_modules/@base-ui/react/esm/menu/submenu-trigger/MenuSubmenuTrigger.js
var MenuSubmenuTrigger = React40.forwardRef(function SubmenuTriggerComponent(componentProps, forwardedRef) {
  const {
    render,
    className,
    label,
  ...
  const registerTrigger = React40.useCallback((element2) => {
  ...
  const handleTriggerElementRef = React40.useCallback((el) => {
