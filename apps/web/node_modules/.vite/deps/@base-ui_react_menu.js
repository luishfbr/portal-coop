...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  React28.useImperativeHandle(ctx?.positionerRef, () => positionerElement, [positionerElement]);
  React28.useImperativeHandle(ctx?.actionsRef, () => ({
    setOpen
  }), [setOpen]);
...
function useCompositeItem(params = {}) {
  ...
  const compositeProps = React30.useMemo(() => ({
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React31.useRef(null);
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React32.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const floatingTreeRoot = React33.useMemo(() => {
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime10.jsxs)(React33.Fragment, {
      ...
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime10.jsx)(React33.Fragment, {
        children: element
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React33.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuViewport = React34.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
// ../../node_modules/@base-ui/react/esm/menu/submenu-trigger/MenuSubmenuTrigger.js
var MenuSubmenuTrigger = React35.forwardRef(function SubmenuTriggerComponent(componentProps, forwardedRef) {
  const {
    render,
    className,
    label,
  ...
  const registerTrigger = React35.useCallback((element2) => {
  ...
  const triggerElementRef = React35.useRef(null);
  const handleTriggerElementRef = React35.useCallback((el) => {
