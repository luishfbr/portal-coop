...
var FloatingPortal = React4.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
...
var useFloatingParentNodeId = () => React5.useContext(FloatingNodeContext)?.id || null;
var useFloatingTree = (externalTree) => {
  const contextTree = React5.useContext(FloatingTreeContext);
...
function FloatingFocusManager(props) {
  ...
  const orderRef = React6.useRef(["content"]);
  ...
  const lastFocusedTabbableRef = React6.useRef(null);
...
function fastComponentRef(fn) {
  return React11.forwardRef(fastComponent(fn));
}
...
//# sourceMappingURL=chunk-SU2O5EHG.js.map
