...
function useAriaLabelledBy(explicitAriaLabelledBy, labelId, labelSourceRef, enableFallback = true, labelSourceId) {
  const [fallbackAriaLabelledBy, setFallbackAriaLabelledBy] = React2.useState();
...
var CheckboxGroupContext = React3.createContext(void 0);
if (true) CheckboxGroupContext.displayName = "CheckboxGroupContext";
function useCheckboxGroupContext(optional = true) {
  const context = React3.useContext(CheckboxGroupContext);
...
//# sourceMappingURL=chunk-LWNQWNRB.js.map
